    ...
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#f0ecec] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        ...
        >
            <Image 
                ...
                src='https://images.unsplash.com/photo-1635756837851-d3b6edbaa11c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bG9nb3N8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60'
                width={200}
                height={200}
                alt='Company logo'    
            />
        ...
        <div className='px-0 md:px-10'>
            ...
            <p className='uppercase py-5 text-gray-300'>September, 2021 - November, 2022</p>
            <ul className='list-disc space-y-4 ml-5 text-lg'>
                <li>Learned how to build a full-stack web application using the MERN stack</li>
                <li>Soft skills</li>
